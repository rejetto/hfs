...
export default function AccountForm({ account, done, groups, addToBar, reload }: FormProps) {
    ...
    return h(Form, {
        ...
        fields: [
            ...
            { k: 'disabled', comp: BoolField, fromField: x=>!x, toField: x=>!x, label: "Enabled", xs: 5, md: 6, xl: 4,
            ...
            { k: 'admin', comp: BoolField, xs: true, fromField: (v:boolean) => v||null, label: "Admin-panel access",
